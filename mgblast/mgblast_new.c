static char const rcsid[] = "$Id: mgblast.c,v 6.174g 2005/10/31 14:15:10 madden Exp $";
/* $Id: mgblast.c,v 6.174 2005/10/31 14:15:10 madden Exp $
**************************************************************************
*                                                                         *
*                             COPYRIGHT NOTICE                            *
*                                                                         *
   ...
   Boolean traditional_formatting;
    ...
    traditional_formatting = 
        (myargs[ARG_OUTTYPE].intvalue == MBLAST_ALIGNMENTS ||
         ...
         /*#ifdef MGBLAST_OPTS
          || myargs[ARG_OUTTYPE].intvalue >= MBLAST_FLTHITS
         #endif*/
         );
